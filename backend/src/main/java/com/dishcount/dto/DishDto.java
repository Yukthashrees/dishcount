...
public class DishDto {
    ...
    public DishDto(Long id, String name, String description, String category, BigDecimal basePrice, String imageUrl, Double rating, Long restaurantId, String restaurantName) {
        this.id = id;
        this.name = name;
    ...
    public static class Builder {
        ...
        public DishDto build() {
            return new DishDto(id, name, description, category, basePrice, imageUrl, rating, restaurantId, restaurantName);
        }
    }
}
